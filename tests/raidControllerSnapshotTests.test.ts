...
describe('Raid logic holds', ()=>{
    test('Win desert raid scenario', () =>{
        const cardsPicker = new BakedHandPicker([
            { id: '1', name: 'arrow_shot', type: 'attack', level: 1 },
            { id: '2', name: 'ignite', type: 'modifier', level: 1 },
            { id: '3', name: 'arrow_shot', type: 'attack', level: 1 },
            { id: '4', name: 'ignite', type: 'modifier', level: 1 },
            { id: '5', name: 'arrow_shot', type: 'attack', level: 1 },
            { id: '6', name: 'ignite', type: 'modifier', level: 1 },
        ])
